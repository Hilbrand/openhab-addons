...
public enum CosemObjectType {
    ...
    // new CosemValueDescriptor<Power>(SmartHomeUnits.WATT)),
    ...
    // new CosemValueDescriptor<Power>(MetricPrefix.KILO(SmartHomeUnits.WATT))),
    // EMETER_TRESHOLD_A_V2_1(new OBISIdentifier(1, 0, 17, 0, 0, null),
    // new CosemValueDescriptor<ElectricCurrent>(SmartHomeUnits.AMPERE)),
    // EMETER_TRESHOLD_A(new OBISIdentifier(0, 0, 17, 0, 0, null),
    // new CosemValueDescriptor<ElectricCurrent>(SmartHomeUnits.AMPERE)),
    ...
    // new CosemValueDescriptor<ElectricPotential>(SmartHomeUnits.VOLT)),
    ...
    // new CosemValueDescriptor(CosemDate.class, "", "timestamp")),
    // WMETER_VALUE_V3(new OBISIdentifier(0, null, 24, 3, 0, null), new
    // CosemValueDescriptor<Volume>(SIUnits.CUBIC_METRE)),
    //
    // /* M3 Meter (Gas, Water) */
