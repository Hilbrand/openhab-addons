...
public class DimmerDevice extends SwitchDevice {
    ...
    public boolean handleCommand(String channelId, Connection connection, Command command,
        ...
        return CHANNEL_BRIGHTNESS.equals(channelId) ? handleBrightnessChannel(connection, command)
     ...
     */
    private boolean handleBrightnessChannel(Connection connection, Command command) throws IOException {
